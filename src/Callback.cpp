...
// Callbacks
// https://vtk.org/Wiki/VTK/Tutorials/Callbacks
// https://discourse.vtk.org/t/vtkcallbackcommand-for-class-member-functions/6591
...
public:
  ...
  static vtkDistanceWidgetCommand *New() {
    return new vtkDistanceWidgetCommand;
  }
...
void vtkDistanceWidgetCommand::Execute(vtkObject *pCaller, unsigned long event,
                                       void *callData) {
  std::cout << "======================================================"
            << std::endl;
}
