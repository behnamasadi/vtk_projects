...
int main(int argc, char *argv[]) {
  ...
  sphereSource->SetThetaResolution(3000);
  sphereSource->SetPhiResolution(3000);
  sphereSource->Update();
  ...
  maskPoints->SetOnRatio(10); // Adjust the ratio for the point cloud density
  ...
  //   normalMapper->GetActor()->GetProperty()->SetColor(
  //       1.0, 0.0, 0.0); // High resolution: Red
  //   pointCloudMapper->GetActor()->GetProperty()->SetColor(
  //       0.0, 1.0, 0.0); // Medium resolution: Green
  //   outlineMapper->GetActor()->GetProperty()->SetColor(
  //       0.0, 0.0, 1.0); // Low resolution: Blue
  ...
  renderWindowInteractor->SetStillUpdateRate(0.5);
...
//   vtkSmartPointer<vtkLODActor>::New(); lodActor->SetMapper(normalMapper); //
//   High resolution lodActor->AddLODMapper(pointCloudMapper); // Medium
//   resolution lodActor->AddLODMapper(outlineMapper);    // Low resolution
...
//   //        i++) {
//   //     lodActor->GetLODMappers().   .get[i].PrintSelf(std::cout,
//   vtkIndent());
//   //   }
...
//   //   lodActor->GetLODProperty(0)->SetColor(1.0, 0.0, 0.0); // High
//   resolution:
//   //   Red lodActor->GetLODProperty(1)->SetColor(0.0, 1.0,
//   //                                         0.0); // Medium resolution:
//   Green
//   //   lodActor->GetLODProperty(2)->SetColor(0.0, 0.0, 1.0); // Low
//   resolution:
//   //   Blue
